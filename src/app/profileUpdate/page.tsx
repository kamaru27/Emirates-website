...
const mySchema = z.object({
  ...
  oldPassword: z.string().min(5, { message: "Password min 5 is required." }),
  newPassword: z.string().min(5, { message: "Password min 5 is required." }),
confirmedPassword: z.string().min(5, { message: "Password min 5 is required." }),
});
